 ...
 * File name: libcli.h
 * Description: describes the cli library (based on libcli)
 *
...
//void cli_print(const char *format, ...) __attribute__((format (printf, 1, 2)));
...
//void cli_error(const char *format, ...) __attribute__((format (printf, 1, 2)));
